...
chisqtestGC(table1)
```
The p-value for the chisq test is .02 < .05, so we reject the null hypothesis and conclude we have evidence to support the contention that gun ownership and whether it favors captial punishment are related. 
...
$H_0$ : The bigbang theory is independent of belief in the afterlife.
...
chisqtestGC(table1)
```
The p-value for the chisq test is .0801 > .05, so we fail to reject null hypothesis and conclude we do not have evidence to support the contention that big bang theory and post life are related. 
...
$H_0$ : There is no relationship bewteen captial punishment and whether one is in favor of captial punishment and race.
...
This barcharts shows that the white and other race have very little differences. However, the black race are the most likely to oppose captial punishment. 
...
The p-value for the chisq test is .0004 < .05, so we reject the null hypothesis and conclude we have evidence to support the contention that captial punishment that there is a relationship bewteen captial punishment and race.
...
<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->
 ...
 So, we concluded that we have evidence to support the contention that captial punishment that there is a relationship bewteen captial punishment and race.
